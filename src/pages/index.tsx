      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        >
          ...
          <p className="text-sm text-slate-600 mb-8 max-w-xl">
            Scroll through authentic, on-page reviews captured directly using Word of Mouth widgets.
          </p>
